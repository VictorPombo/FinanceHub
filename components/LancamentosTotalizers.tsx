...
export default function LancamentosTotalizers({ lancamentos, currentMonthKey }: Props) {
  ...
  return (
    <div className="w-full shrink-0 px-2 md:px-0">
      <div className="flex flex-col md:flex-row w-full bg-gradient-to-r from-[#020617] via-[#0F172A] to-[#020617] shadow-xl border-b-[2px] border-purple-600 overflow-hidden md:rounded-t mx-auto md:w-[calc(100%-16px)] mt-1">
        <div className="flex-1 p-2 md:p-3 border-b md:border-b-0 md:border-r border-white/5 hover:bg-white/5 transition-colors">
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="text-slate-400 text-[9px] md:text-[10px] font-bold uppercase tracking-widest">Total Entradas</div>
          </div>
        ...
        <div className="flex-1 p-2 md:p-3 border-b md:border-b-0 md:border-r border-white/5 hover:bg-white/5 transition-colors">
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="text-slate-400 text-[9px] md:text-[10px] font-bold uppercase tracking-widest">Total Saídas</div>
          </div>
        ...
        <div className="flex-1 p-2 md:p-3 hover:bg-white/5 transition-colors">
          <div className="flex items-center gap-2 mb-1">
            ...
            <div className="text-slate-400 text-[9px] md:text-[10px] font-bold uppercase tracking-widest">Saldo Atual</div>
          </div>
      ...
      <div className="flex flex-col md:flex-row w-full bg-[#020617] border-b border-x border-slate-800 mx-auto md:w-[calc(100%-16px)] md:rounded-b overflow-hidden text-xs">
        <div className="flex-1 px-3 md:px-4 py-1.5 border-b md:border-b-0 md:border-r border-slate-800 flex items-center justify-between">
          <span className="text-slate-500 text-[9px] md:text-[10px] font-semibold uppercase tracking-widest">Mês Oculto</span>
          <span className="bg-purple-900/40 border border-purple-800/50 text-purple-400 px-1.5 py-0.5 rounded text-[9px] md:text-[10px] font-bold shadow-sm">Atual</span>
        </div>
        <div className="flex-1 px-3 md:px-4 py-1.5 border-b md:border-b-0 md:border-r border-slate-800 flex items-center justify-between">
